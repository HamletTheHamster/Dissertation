...
To find the power of the backscattered signal, we would integrate this intensity over the effective area (acousto-optic mode overlap). For a uniform area \(A_{\rm eff}^{\rm ao}\), this gives
\\
\begin{equation}
