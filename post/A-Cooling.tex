...
\begin{table}[h]
  ...
  \begin{tabular}{
    ...
    % Each cell uses \num{... +- ...} so that siunitx formats it as “value ± uncertainty”
		\num{10.00} & \num{4.12} & \num{3.015(0.0043)} & \num{97.315(0.119)} & \num{2.2690(0.0001)} & \num{-0.006(0.0017)} \\
    \num{30.00} & \num{12.37} & \num{8.747(0.0061)} & \num{99.097(0.0547)} & \num{2.2690(0.0000)} & \num{0.015(0.0019)} \\
    \num{50.00} & \num{20.62} & \num{14.224(0.0097)} & \num{99.793(0.0449)} & \num{2.2690(0.0000)} & \num{0.032(0.0021)} \\
    \num{70.00} & \num{28.86} & \num{19.123(0.0167)} & \num{101.147(0.0508)} & \num{2.2690(0.0000)} & \num{0.015(0.0027)} \\
...
\begin{table}[h]
  \centering
  \caption{Measured Stokes parameters, in the same format as Table~\ref{tab:Cooling:anti-Stokes}.}
  \label{tab:Cooling:Stokes}
  \begin{tabular}{
			S   % Pump Power
			S   % Intrafiber
			S[table-align-uncertainty, separate-uncertainty]   % Amplitude
			S[table-align-uncertainty, separate-uncertainty]   % Linewidth
			S[table-align-uncertainty, separate-uncertainty]   % Center
			S[table-align-uncertainty, separate-uncertainty]   % Offset
    }
    \toprule
		\multicolumn{1}{c}{\(\mathbf{P}_{\mathrm{\textbf{P}}}\)} &
    \multicolumn{1}{c}{\(\mathbf{P}_{\mathrm{\textbf{Intra}}}\)} &
