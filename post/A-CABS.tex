\doublespacing
\chapter{Supplementary Information for Chapter~\ref{ch:CABS}}
\label{appendix: CABS}
\acresetall
...
I now turn to the spatial evolution of the optical fields, described by the wave equation,
\\
\begin{equation}
...
\end{equation}
\\
I again assume steady-state conditions, allowing the time derivative term to be dropped. Plugging in the acoustic field amplitude (Equation~\ref{eq:Acoustic field amplitude}), I arrive at the coupled-amplitude wave equations for the optical fields,
\\
\begin{equation}
...
\end{equation}
\\
I drop the very small signal amplitude terms on the right side of Equations~\ref{eq:Pump coupled-amplitude wave equation}-\ref{eq:Signal coupled-amplitude wave equation} and integrate each along the effective length to get the amplitudes,
\\
\begin{equation}
...
\end{equation}
\\
I focus on the signal amplitude given by Equation~\ref{eq:Signal amplitude}, noting that close to resonance, the denomenator of the middle term containing \(\Omega\) can be approximated as,
\\
\begin{equation}
