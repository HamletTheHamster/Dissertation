...
\begin{table}[h]
    ...
    \begin{tabular}{c c c c c c}
        ...
        \bottomrule
    \end{tabular}
    \caption{Experimental parameters used in observing \(P_{\rm Sig}\sim\) \SI{5}{\femto\watt} sensitivity of the \ac{CoBS} instrument. The resulting spectra is shown in Figure~\ref{fig:CoBS:5fWSensitivity}.}
