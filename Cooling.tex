...
\section{Experimental Methods and Design}
\label{Cooling:sec:ExperimentalMethodsandDesign}
...
\subsection{Cooling Platform: \texorpdfstring{$CS_{2}$}{CS2}-\acl{LCOF}}
\label{Cooling:subsec:CoolingPlatform}
...
\subsection{Pump-Probe Verification Experiment}
\label{Cooling:subsec:Pump-ProbeVerificationExperiment}
...
\subsection{Spontaneous Cooling Results}
\label{Cooling:subsec:SpontaneousCoolingResults}
...
\subsection{Pump-Probe Verification Results}
\label{Cooling:subsec:Pump-ProbeVerificationResults}

%--------------------------------------------------------------------%

\section{Future Directions and Broader Implications}
\label{Cooling:sec:FutureDirectionsandBroaderImplications}
