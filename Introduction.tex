...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Spontaneous Light Scattering}
\label{sec:Introduction:Spontaneous-Light-Scattering}
Light scattering is the redirection of light as a result of interactions with the particles or molecules that make up a material medium. In each of the types of scattering mentioned above (Rayleigh, Brillouin, Raman, Rayleigh-wing), light scattering occurs because of changes in the optical properties of the host material. To illustrate why this is the case, consider a material whose particles are entirely spatially and temporally invariant---that is, a completely homogeneous medium. Figure \ref{fig:Introduction:homogeneous-material-no-scatter}, shows uniform plane wave of light incident on two nearby volume elements of such a medium. For any given wavelength $\lambda$ and any scattering angle $\theta \neq 0$ there would exist a nearby volume element at distance $\frac{\lambda}{2\sin\theta}$ away which would also scatter the incident light in the direction of $\theta$. Thus, the two scattered fields would differ in phase by exactly $\frac{\lambda}{2}$ to produce perfect destructive interference and no net scattered field.
