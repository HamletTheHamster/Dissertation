...
where \(\epsilon \equiv (\Omega - \Omega_{B})/(\Gamma_{B}/2)\) is the dimensionless detuning from the Brillouin peak (measured in half the spectral linewidth) and \(q = \text{(resonant amplitude)}/\text{(background)}\) is the Fano asymmetry parameter.
